...
in the C implementation of Python](https://peps.python.org/pep-0007/).

This document and [PEP 257](https://peps.python.org/pep-0257/) (Docstring Conventions) were adapted from
...
spectrum of Python code.  As [PEP 20](https://peps.python.org/pep-0020/) says, "Readability counts".
...
<a id="multiline-if-statements"></a>
...
<a id="pep8-operator-linebreak"></a>
...
consistent with the docstring convention in [PEP 257](https://peps.python.org/pep-0257/).
...
- Function annotations should use the normal rules for colons and
  ...
  [Function Annotations](#function-annotations) below for more about function annotations.):
...
(a.k.a. "docstrings") are immortalized in [PEP 257](https://peps.python.org/pep-0257/).
...
- [PEP 257](https://peps.python.org/pep-0257/) describes good docstring conventions.  Note that most
...
as described in the
[policy section](https://peps.python.org/pep-3131/#policy-specification)
of [PEP 3131](https://peps.python.org/pep-3131/).
...
Names of type variables introduced in [PEP 484](https://peps.python.org/pep-0484/) should normally use CapWords
...
- When implementing ordering operations with rich comparisons, it is
  ...
  [PEP 207](https://peps.python.org/pep-0207/) indicates that reflexivity rules *are* assumed by Python.
...
- Derive exceptions from `Exception` rather than `BaseException`.
  ...
  *catching* the exceptions is likely to need, rather than the locations
  ...
  "A problem occurred" (see [PEP 3151](https://peps.python.org/pep-3151/) for an example of this lesson being
...
With the acceptance of [PEP 484](https://peps.python.org/pep-0484/), the style rules for function
annotations have changed.

- Function annotations should use [PEP 484](https://peps.python.org/pep-0484/) syntax (there are some
...
- However, outside the stdlib, experiments within the rules of [PEP 484](https://peps.python.org/pep-0484/)
  are now encouraged.  For example, marking up a large third party
  library or application with [PEP 484](https://peps.python.org/pep-0484/) style type annotations,
...
- For code that wants to make a different use of function annotations
  ...
  type checkers can be found in [PEP 484](https://peps.python.org/pep-0484/).)
...
- Users who don't want to use type checkers are free to ignore them.
  ...
  [PEP 484](https://peps.python.org/pep-0484/) recommends the use of stub files: .pyi files that are read
...
[PEP 526](https://peps.python.org/pep-0526/) introduced variable annotations. The style recommendations for them are
...
- Although the [PEP 526](https://peps.python.org/pep-0526/) is accepted for Python 3.6, the variable annotation
  syntax is the preferred syntax for stub files on all versions of Python
  (see [PEP 484](https://peps.python.org/pep-0484/) for details).
